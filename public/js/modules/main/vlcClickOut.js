                ...
                link: function (scope, element, attrs) {
                    ...
                    angular.element($window).on('click', function (event) {
                        ...
                        //start Jacsiel Code*/
                             ...
                             */
                        if((angular.element(event.target).parents(".popUp").length>0) || (angular.element(event.target).parents("#lyrAlert").length>0) || (angular.element(event.target).parents(".md-autocomplete-suggestions").length>0) || (angular.element(event.target).parents(".md-calendar-date").length>0)){
