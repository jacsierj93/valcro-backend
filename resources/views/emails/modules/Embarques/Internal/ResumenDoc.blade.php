    ...
    <table style="border-spacing: 0;margin: auto;padding: 0; width: 600px; ">
        ...
        <tr style="margin: 0;padding: 0">
            ...
            <td style="color: rgb(140,140,140);margin: 0;padding:0">
                <table style="max-width: 100%;display: block;margin: auto;padding:0 ;box-shadow:0 0 14px rgb(241,241,241)">
                    <tbody>
                    <tr style="margin: 0;padding:0">
                        <td style="color: rgb(140,140,140);margin: 0;padding: 10px;">
                            <div style="width: 100%;margin: 0;padding:0">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tbody>
                                    <tr style="margin: 0;padding:0"><td align="center" width="30%" style="color: rgb(140,140,140);margin: 0;padding: 10px;; text-align: left;"><img width="150px"  style="margin: 0;padding:0" src='http://valcro.com.ve/images/logo-head.png' ></td>
                                    ...
                                    <tr style="margin: 0;padding:0">
                                        <td  width="90%" align="center" style="color: rgb(140,140,140);margin: 0;padding: 10px 0 0 0 ;">
                                            <div style="text-align: center;font-size: 22px;border-radius: 10px;background: rgb(238,141,0);margin: 0 5px 0 0;padding: 14px 10px;" align="center">
                                                <a href="http://10.15.2.76/dev/External/Email?module=order&id={{$id}}&tipo={{$tipo}}"  style="color: #ffffff;text-decoration: none;margin: 0;padding:0" target="_blank" tabindex="-1" rel="external nofollow">Click aqu&iacute para ver el Documento</a>
                                            </div>
                                        </td>
                                    </tr>
                                    </tbody>
