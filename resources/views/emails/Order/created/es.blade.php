                            ...
                            <div style="width: 100%;margin: 0;padding: 0">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        ...
                                        <td width="30%" align="left" style="color: rgb(140,140,140);margin: 0;padding: 10px;font-weight: bold;">Puerto
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tbody>
                                    <tr>
                                        <td width="30%" align="left" style="color: rgb(140,140,140);margin: 0;padding: 10px;font-weight: bold;">Monto
                                            <p style="color: rgb(0,0,0)!important;font-size: 15px!important;margin: 0;padding: 0px;font-weight: normal;max-width: 600px; overflow: hidden;word-break: break-all;" >
                                                {{($model->monto != null) ? $model->monto : 'No asignado' }}
                                            </p>
                                        </td>
                                        <td width="30%"align="left" style="color: rgb(140,140,140);margin: 0;padding: 10px;font-weight: bold;">Moneda
                                            <p style="color: rgb(0,0,0)!important;font-size: 15px!important;margin: 0;padding: 0px;font-weight: normal;max-width: 600px; overflow: hidden;word-break: break-all;" >
                                                {{($model->coin != null) ? $model->coin->nombre : 'No asignado' }}
                                            </p>
                                        </td>
                                        <td width="30%" align="left" style="color: rgb(140,140,140);margin: 0;padding: 10px;font-weight: bold;">Tasa
                                            <p style="color: rgb(0,0,0)!important;font-size: 15px!important;margin: 0;padding: 0px;font-weight: normal;max-width: 600px; overflow: hidden;word-break: break-all;" >
                                                {{$model->tasa }}
                                            </p>
                                        </td>
