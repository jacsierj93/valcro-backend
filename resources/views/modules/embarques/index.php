    ...
    <div class="contentHolder" layout="row" flex>
        ...
        <div layout="column" flex class="md-whiteframe-1dp">
            <div class="botonera" layout="row" layout-align="space-between center">
                ...
                <div  layout="row" layout-align="start center" style="width: 200px;">
                    ...
                    <div layout="column" ng-show="module.layer == 'listGlobalTarif'" layout-align="center center" ng-click="detailGlobalTarif()">
                        <span class="icon-Agregar" style="font-size: 24px"></span>
                        <md-tooltip >
                            Nuevo Documento
                        </md-tooltip>
        ...
        <md-sidenav class="md-sidenav-right md-whiteframe-2dp md-sidenav-layer" md-disable-backdrop="true" md-component-id="listShipment" id="listShipment"   >
            <md-content  layout="row" flex class="sideNavContent" ng-controller= "listShipmentCtrl">
                ...
                <div  style="width: 16px;" ng-mouseover="$parent.showNext(true); $parent.setNext = ShipmentFinish;"  > </div>
            </md-content>
        </md-sidenav>
        <!------------------------------------------- lista de embarques finalizados ------------------------------------------------------------------------->
        <md-sidenav class="md-sidenav-right md-whiteframe-2dp md-sidenav-layer" md-disable-backdrop="true" md-component-id="listShipmentFinalize" id="listShipmentFinalize"   >
            <md-content  layout="row" flex class="sideNavContent" ng-controller= "listShipmentFinalizeCtrl">
                <div layout="column" flex>
                    <div layout="row" class="focused">
                        <div active-left ></div>
                        <div layout="row" flex class="form-row-head form-row-head-select">
                    ...
                    <div layout="row">
                        ...
                        <div layout="row"  flex style="padding-right: 4px;">
                            ...
                            <div layout="row" class="int"  >
                                ...
                                <grid-order-by ng-model="tbl" key="countItems"></grid-order-by>
                    ...
                    <div layout="row"  class="gridContent" flex>
                        ...
                        <div layout="column" flex=""   >
                            <div   ng-repeat="item in tbl.data | filter : tbl.filter:strict | orderBy : tbl.order as filter"    >
                                <div layout="row" class="cellGridHolder" >
                                    <div class="cellGrid int" ng-click="setData(item)">{{item.id}}</div>
                                    <div flex class="cellGrid" ng-click="setData(item)">{{item.nro_factura}}</div>
                                    <div flex class="cellGrid" ng-click="setData(item)">{{item.titulo}}</div>
                                    <div flex class="cellGrid" ng-click="setData(item)"> <div class="date {{'green'+item.catfecha_carga}}">{{item.fecha_carga |  date:'dd/MM/yyyy' }}</div></div>
                                    <div flex class="cellGrid" ng-click="setData(item)"><div  class="date {{'green'+item.catfecha_vnz}}" >{{item.fecha_vnz | date:'dd/MM/yyyy'}}</div></div>
                                    <div flex class="cellGrid " ng-click="setData(item)"><div  class="date {{'green'+item.catfecha_tienda}}">{{item.fecha_tienda| date:'dd/MM/yyyy'}}</div></div>
                                    <div class="cellGrid int" ng-click="setData(item)">{{item.countItems}}</div>
            ...
            <md-content  layout="row" flex class="sideNavContent" ng-controller= "listGlobalTarifCtrl">
                <div layout="column" flex>
                        ...
                        <div layout="row"  flex style="padding-right: 4px;">
                            ...
                            <div layout="row" style="width: 200px;">
                                <md-input-container class="md-block"  flex>
                                    <label>Creada</label>
                                    <input type="text" class="inputFilter"  ng-minlength="2"
                                           ng-model="tbl.filter.created_at"
                                           skip-tab
                                    >
                                </md-input-container>
                                <grid-order-by ng-model="tbl" key="created_at"></grid-order-by>
                    ...
                    <form layout="row"  class="gridContent" flex>
                        <div active-left ></div>
                        <div layout="column" flex=""   >
                            <div   ng-repeat="item in tbl.data | filter: tbl.filter |  orderBy : tbl.order as filter"    >
                                <div layout="row" class="cellGridHolder"  ng-click="setData(item)" >
                                    <div style="width: 98px;" class="cellGrid">{{item.id}}</div>
                                    <div flex class="cellGrid">{{item.objs.freight_forwarder_id.nombre}}</div>
                                    <div flex class="cellGrid">{{item.comentario}}</div>
                                    <div  style="width: 200px;" class="cellGrid">{{item.created_at | date : 'dd/MM/yyyy'}}</div>
                                </div>
                            </div>
                            <div layout="column" layout-align="center center" flex ng-show="filter == 0">
                                No hay datos para mostrar
        ...
        <md-sidenav class="md-sidenav-right md-whiteframe-2dp md-sidenav-layer" md-disable-backdrop="true" md-component-id="detailGlobalTarif" id="detailGlobalTarif"   >
            <md-content  layout="row" flex class="sideNavContent" ng-controller= "detailGlobalTarifCtrl" >
                <div layout="column" flex>
                    <form layout="row" class="focused" name="head">
                        <div active-left  ></div>
                        <div layout="column" flex>
                            <div layout="row" >
                            ...
                            <div layout="row" class="row" >
                                <md-input-container class="md-block" flex  >
                                    <label>Comentario</label>
                                    <input  ng-model="model.comentario"
                                    >
                                </md-input-container>
                            </div>
                            <div layout="row" class="row">
                            ...
                            <div layout="row" class="row">
                                <div class="adj-box-left autoclick " flex="20" style="color: rgb(176,176,176);margin-right: 8px;" skip-tab  ng-click="openAdjs()">
                                    <div  class="vlc-buttom" style="float:left;margin-right: 0"> {{model.adjs.length}}</div>
                                    <div style="margin-top: 8px;    border-bottom: dotted 0.6px rgb(176,176,176);margin-left: 26px;">Adjuntos</div>
                                </div>
                                <div class="adj-box-left autoclick " flex="20" style="color: rgb(176,176,176);margin-right: 8px;" skip-tab ng-click="openItems()">
                                    <div  class="vlc-buttom" style="float:left;margin-right: 0">{{tbl.data.length}}</div>
                                    <div style="margin-top: 8px;    border-bottom: dotted 0.6px rgb(176,176,176);margin-left: 26px;">Items</div>
                                </div>
        ...
        <!------------------------------------------- detalle de embarques creados ------------------------------------------------------------------------->
        <md-sidenav class="md-sidenav-right md-whiteframe-2dp md-sidenav-layer" md-disable-backdrop="true" md-component-id="detailShipmentFinalize" id="detailShipmentFinalize"   >
            <md-content  layout="row" flex class="sideNavContent" ng-controller= "detailShipmentFinalizeCtrl" >
                <div layout="column" flex style="padding-right: 2px;">
                    <form class="focused" name="detailShipmenthead" layout="row" >
                        <div active-left  ></div>
                        <div layout="column" flex>
                            ...
                            <div layout="row" class="row"  >
                                <md-input-container class="md-block" flex  >
                                    <label>Proveedor</label>
                                    <input  ng-model="model.provider.razon_social"
                                            ng-disabled="true"
                                    >
                                </md-input-container>
                                <md-input-container class="md-block" flex="15">
                                    <label>N°</label>
                                    <input  ng-model="model.id"
                                            ng-disabled="true"
                                            skip-tab
                                    >
                                </md-input-container>
                                <div layout="row" class="date-row" style="min-width: 0;">
                                    <div layout="column" class="md-block" layout-align="center center"  >
                                        <div>Llego</div>
                                    </div>
                                    <div layout="column" class="md-block" layout-align="center center"><div>{{model.fecha_tienda | date : 'dd/MM/yyyy'}}</div></div>
                                </div>
                            </div>
                            <div layout="row" class="row"  >
                                <md-input-container flex>
                                    <label>Titulo</label>
                                    <input  ng-model="model.titulo"
                                            ng-change="toEditHead('titulo', $parent.shipment.titulo ) "
                                            ng-disabled="( session.isblock || $parent.shipment.aprob_superior)"
                                            required
                                            info="Escriba un titulo para facilitar identificacion del embarque"
                        ...
                        <div layout="row"  flex style="padding-right: 4px;">
                            ...
                            <div flex layout="row" class="table-filter-head">
                                <md-input-container class="md-block"  flex>
                                    ...
                                    <input type="text" class="inputFilter"  ng-minlength="2"
                                           ng-model="tbl.filter.exhibicion"
                                           skip-tab
                                    >
                                </md-input-container>
                                <grid-order-by ng-model="tbl" key="saldo"></grid-order-by>
                    ...
                    <div layout="row"  class="gridContent" flex>
                        <div active-left  ></div>
                        <div layout="column" flex>
                            <div   ng-repeat="item in model.items | filter : tbl.filter:strict | orderBy : tbl.order as filter  "    >
                                <div layout="row" class="cellGridHolder" ng-class="{'table-row-select':(select.id == item.id)}" >
                                    ...
                                    <div ng-click="open(item)"  flex class="cellGrid" >{{chequeado(item.llegada)}}</div>
                                    <div ng-click="open(item)"  flex class="cellGrid" >{{calida(item.calida)}}</div>
                                    <div ng-click="open(item)"  flex class="cellGrid" >{{exhibicion(item.exhibicion)}}</div>
                                </div>
                            </div>
                            <div layout="column" layout-align="center center" ng-show="filter.length == 0" flex>
                                No hay datos para mostrar
        ...
        <!------------------------------------------- mini layer crear  items tarifas ------------------------------------------------------------------------->
        <md-sidenav layout="row" class="md-sidenav-right md-whiteframe-2dp popUp md-sidenav-layer"
                    md-disable-backdrop="true" md-component-id="miniTariffItems" id="miniTariffItems"
        >
            <md-content   layout="row" flex class="sideNavContent"   ng-controller="miniTariffItemsCtrl"  >
                <div  layout="column" flex class="layerColumn"   click-out="close($event)" style="padding-left: 12px">
                        ...
                        <div  layout="column"  ng-class="{'form-row-head-select': form == 'head' ,'form-body-select':form == 'head'}" ng-show="form == 'head'">
                            <div style="padding-left: 12px ; padding-right: 4px;" >
                                ...
                                <div layout="row" class="row">
                                    ...
                                    <md-input-container class="md-block" flex  >
                                        <md-autocomplete md-selected-item="puertoSelect"
                                                         info="Selecione el puerto para la nueva tarifa"
                                                         required
                                                         skip-tab
                                                         md-search-text="puertoText"
                                                         md-items="item in puertos | stringKey : puertoText : 'Main_port_name' "
                                ...
                                <div layout="row" class="row">
                                    ...
                                    <md-input-container class="md-block"  flex>
                                        <md-autocomplete md-selected-item="monedaSelect"
                                                         info="Selecione la moneda para la tarifa"
                                                         required
                                                         skip-tab
                                                         md-search-text="monedaText"
                                                         md-auto-select="true"
                    ...
                    <form  name="bond" ng-class="{'focused':form== 'bond'}" flex layout="column" ng-class="{'form-row-head-select': form == 'bond' ,'form-body-select':form == 'bond'}">
                        <div layout="row" class="form-row-head " ng-class="{'form-row-head-select': form == 'bond' ,'form-body-select':form == 'bond'}">
                            <div class="titulo_formulario" flex ng-click="form = 'bond'">
                                <div>
                                    Bondades
                                </div>
                            </div>
        ...
        <!------------------------------------------- mini layer agregar adjuntos ------------------------------------------------------------------------->
        <md-sidenav layout="row" class="md-sidenav-right md-whiteframe-2dp popUp md-sidenav-layer"
                    md-disable-backdrop="true" md-component-id="miniAdjs" id="miniAdjs"
        >
            <md-content   layout="row" flex class="sideNavContent"   ng-controller="miniAdjsCtrl"  >
                <div  layout="column" flex class="layerColumn"   click-out="close($event)" style="padding-left: 12px">
                    <div layout="column" flex >
                        <div layout="row" class="form-row-head form-row-head-select"  >
                            <div class="titulo_formulario" flex>
