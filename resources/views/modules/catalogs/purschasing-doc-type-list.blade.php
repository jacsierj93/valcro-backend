...
@section('main-content')
    ...
    <div class="panel-body">
        <a type="button" href="{{url("catalogs/PurchasingDocumentTypeForm")}}" class="btn bg-orange margin">Crear Nuevo</a>
    </div>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="{{url('catalogs/PurchasingDocumentTypeForm?id='.$result->id)}}">Editar</a></li>
                                    <li><a href="javascript:deletepayPurDoc({{$result->id}})">Borrar</a></li>
                                </ul>
                            </div>
                        </td>
                        <td>{{$result->id}}</td>
