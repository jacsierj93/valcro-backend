...
@section('contentheader_title')
    Maestro de Tipos de Envíos de Proveedores
@endsection
...
@section('main-content')
    ...
    <div class="panel-body">
        <a type="button" href="{{url("catalogs/providerTypesSendForm")}}" class="btn bg-orange margin">Crear Nuevo</a>
    </div>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="{{url('catalogs/providerTypesSendForm?id='.$result->id)}}">Editar</a></li>
