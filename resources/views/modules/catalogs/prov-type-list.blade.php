                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="{{url('catalogs/providerTypesForm?id='.$result->id)}}">Editar</a></li>
                                    <li><a href="javascript:deleteProvTipe({{$result->id}})">Borrar</a></li>
                                </ul>
                            </div>
                        </td>
                        <td>{{$result->id}}</td>
