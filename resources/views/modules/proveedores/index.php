    ...
    <div class="contentHolder" layout="row" flex>
        ...
        <md-content class="barraLateral" ng-controller="ListProv">
            ...
            <div class="boxList" layout="column" flex ng-repeat="item in todos" ng-click="setProv(this)"
                 ng-class="{'listSel' : (item.id ==prov.id),'listSelTemp' : (item.id ==prov.id && !item.id)}">
                <div style="overflow: hidden; text-overflow: ellipsis;" flex>{{ item.razon_social }}</div>
                <div style="height:40px; font-size:31px; overflow: hidden;">{{(item.limCred)?item.limCred:'000000'}}
                </div>
        ...
        <md-sidenav style="margin-top:96px; margin-bottom:48px; width: calc(100% - 288px);" layout="row"
                    class="md-sidenav-right md-whiteframe-2dp" md-disable-backdrop="true" md-component-id="layer0">
            ...
            <md-content class="cntLayerHolder" layout="row" flex ng-controller="resumenProv">
                ...
                <div layout="column" flex>
                    <div flex>
                        ...
                        <div flex style="overflow-y: auto;">
                            <div ng-repeat="direccion in prov.direcciones" style="height: 78px;">
                                <div style="width: 30%; height: 39px; float: left; overflow: hidden; text-overflow: ellipsis;">{{direccion.tipo.descripcion}}</div>
                                <div style="width: 70%; height: 39px; float: left; overflow: hidden; text-overflow: ellipsis;"> {{direccion.country.short_name}}</div>
                    ...
                    <div flex>
                        ...
                        <div flex style="overflow-y: auto;">
                            <div ng-repeat="contact in prov.contacts" style="height: 39px;">
                                <div style="width: 50%; height: 39px; float: left; overflow: hidden; text-overflow: ellipsis;">{{contact.nombre}}</div>
                                <div style="width: 50%; height: 39px; float: left; overflow: hidden; text-overflow: ellipsis;">
                ...
                <div layout="column" flex>
                    <div flex="10">
                        ...
                        <div flex layout="column">
                            <div ng-repeat="moneda in prov.monedas" layout="column"
                                 style="border-bottom: 1px solid rgb(84, 180, 234)">
                    ...
                    <div flex="20">
                        ...
                        <div ng-repeat="point in prov.monedas" ng-show="point.pivot.punto" layout="row"
                             style="border-bottom: 1px solid rgb(84, 180, 234)">
                    ...
                    <div flex="20">
                        <div class="titulo_formulario" layout="Column" layout-align="start start"
                             ng-class="{'title_error' : (prov.limCred.length < 1)}">
                            <div>
                                Limites de Credito
                            </div>
                        </div>
                        <div ng-repeat="lim in prov.limites" layout="row"
                             style="border-bottom: 1px solid rgb(84, 180, 234)">
                    ...
                    <div flex="50">
                        ...
                        <div ng-repeat="bank in prov.banks" layout="column"
                             style="border-bottom: 1px solid rgb(84, 180, 234)">
        ...
        <md-sidenav layout="row" style="margin-top:96px; margin-bottom:48px; width: calc(100% - 312px);"
                    class="md-sidenav-right md-whiteframe-2dp" md-disable-backdrop="true" md-component-id="layer1"
                    id="layer1">
            ...
            <md-content class="cntLayerHolder" layout="column" layout-padding flex ng-controller="AppCtrl">
                ...
                <form name="projectForm" ng-controller="DataProvController" ng-disabled="true">
                    ...
                    <div class="titulo_formulario" layout="Column" layout-align="start start"
                         ng-class="{'onlyread' : (!$parent.edit && prov.id)}">
                        <div>
                            Datos Proveedor
                        </div>
                    </div>
                ...
                <form name="nomvalcroForm" ng-controller="valcroNameController" ng-click="showGrid(true)"
                      click-out="showGrid(false)">
                    <div class="titulo_formulario" layout="row" layout-align="start start"
                         ng-class="{'onlyread' : (!$parent.edit)}">
                        <div flex style="height: 30px;" layout="row">
                            Nombres Valcro
                        </div>
                        <div flex="20" style="height: 30px;">
                            <span ng-repeat="dep in deps"
                                  ng-class="{'iconInactive':(valName.departments.indexOf(dep.id)===-1),'iconActive':(valName.departments.indexOf(dep.id)!==-1)}"
                                  class="{{dep.icon}}" style="font-size: 18px; margin-left: 8px; color:black"></span>
                    ...
                    <div ng-show="isShow">
                        <div ng-repeat="name in valcroName" class="itemName">{{name.name}}</div>
                    </div>
                </form>

                <!-- 19) ########################################## FORMULARIO "Direcciones del Proveedor" ########################################## -->
                <form name="direccionesForm" ng-controller="provAddrsController" ng-click="showGrid(true)"
                      click-out="showGrid(false)">
                    <div class="titulo_formulario" layout="row" layout-align="start start"
                         ng-class="{'onlyread' : (!$parent.edit)}">
                        <div style="height: 30px;" layout="row">
                            Direcciones
                        </div>
                    </div>
                    ...
                    <md-input-container class="md-block" flex ng-show="dir.tipo==2">
                        <label>puertos</label>
                        <md-select ng-model="dir.ports" multiple="" md-no-ink
                                   ng-disabled="$parent.enabled || !dir.pais">
                            <md-option ng-repeat="port in ports | customFind : dir.pais : searchPort"
                                       value="{{port.id}}">
                                {{port.Main_port_name}}
                            </md-option>
                        </md-select>
                    ...
                    <md-input-container class="md-block" flex>
                        ...
                        <input ng-disabled="$parent.enabled" maxlength="250" ng-minlength="5" required md-no-asterisk
                               name="direccProv" ng-model="dir.direccProv">
                    </md-input-container>
                        ...
                        <div id="grid" style="overflow-y: auto; height: 120px">
                            <div flex ng-repeat="add in address" ng-click="toEdit(this)">
                                <div layout="row" layout-wrap class="cellGridHolder">
                                    ...
                                    <div flex="20" class="cellGrid" style="overflow: hidden; text-overflow:ellipsis ">
                                        {{add.pais.short_name}}
                                    </div>
                ...
                <form name="provContactosForm" ng-controller="contactProv" ng-click="showGrid(true)"
                    ...
                    <div layout="row">
                        ...
                        <md-input-container class="md-block" flex="30">
                            ...
                            <input ng-disabled="$parent.enabled" name="nombreCont" maxlength="55" ng-minlength="3"
                                   required md-no-asterisk ng-model="cnt.nombreCont" ng-dblclick="book()">
                        </md-input-container>

                        <md-input-container class="md-block" flex="35">
                            <label>Email</label>
                            <input ng-disabled="$parent.enabled" name="emailCont" minlength="10" maxlength="100"
                                   required ng-model="cnt.emailCont"
                                   ng-pattern="/^.+@.+\..+$/"/>
                        </md-input-container>
                        <md-input-container class="md-block" flex="15">
                            <label>Pais de Residencia</label>
                            <md-select ng-disabled="$parent.enabled" ng-model="cnt.pais" ng-disabled="(cnt.id===false)"
                                       md-no-ink>
                                <md-option ng-repeat="pais in paises" value="{{pais.id}}">
                                    {{pais.short_name}}
                                </md-option>
                        ...
                        <md-input-container class="md-block" flex="20">
                            <label>Telefono</label>
                            <input ng-disabled="$parent.enabled" name="contTelf" md-no-asterisk ng-model="cnt.contTelf"
                                   ng-disabled="(cnt.id===false)"/>
                        </md-input-container>
                    ...
                    <div layout="row">
                        <div layout="row" flex="30">
                            <md-input-container flex>
                                <label>Idiomas</label>
                                <md-select ng-disabled="$parent.enabled" ng-model="cnt.languaje" multiple=""
                                           ng-disabled="(cnt.id===false)" md-no-ink>
                        ...
                        <div layout="row" flex="30">
                            <md-input-container flex>
                                <label>cargos</label>
                                <md-select ng-model="cnt.cargo" multiple=""
                                           ng-disabled="(cnt.id===false) || $parent.enabled" md-no-ink>
                                    <md-option ng-value="cargo.id" ng-repeat="cargo in cargos">{{cargo.cargo}}
                                    </md-option>
                                </md-select>
                            </md-input-container>
                        </div>
                        ...
                        <md-input-container class="md-block" flex="40">
                            ...
                            <input ng-disabled="$parent.enabled" name="cntcRespon" maxlength="100" ng-minlength="3"
                                   ng-model="cnt.responsability" ng-disabled="(cnt.id===false)">
                        </md-input-container>
                    ...
                    <div layout="row" flex>
                        <md-input-container class="md-block" flex>
                            ...
                            <input ng-disabled="$parent.enabled" name="cntcDirOfc" maxlength="200" ng-model="cnt.dirOff"
                                   ng-minlength="3" ng-disabled="(cnt.id===false)">
                        </md-input-container>
                    </div>
        ...
        <md-sidenav style="margin-top:96px; margin-bottom:48px; width: 360px;"
                    class="md-sidenav-right md-whiteframe-2dp" md-disable-backdrop="true" md-component-id="nomValLyr">
        ...
        <md-sidenav style="margin-top:96px; margin-bottom:48px; width: 360px;"
                    class="md-sidenav-right md-whiteframe-2dp" md-disable-backdrop="true" md-component-id="contactBook">
                ...
                <div style="height: 100%; overflow:scroll">
                    <div flex ng-repeat="cont in allContact" flex="column" ng-click="toEdit(this)">
                        <div layout="column" layout-wrap class="cellGridHolder cellGrid" style="height: 72px">
                            ...
                            <div flex style="height: 24px"><span ng-repeat="prov in cont.provs">{{prov.prov}}, </span>
                            </div>
                        </div>
        ...
        <md-sidenav style="margin-top:96px; margin-bottom:48px; width: calc(100% - 336px);" layout="row"
                    class="md-sidenav-right md-whiteframe-2dp" md-disable-backdrop="true" md-component-id="layer2"
                    id="layer2">
            <md-content class="cntLayerHolder" layout="column" layout-padding flex>

                <!-- ########################################## FORMULARIO INFO BANCARIA ########################################## -->
                <form ng-controller="bankInfoController" name="bankInfoForm" ng-click="showGrid(true)"
                      click-out="showGrid(false)">
                    ...
                    <div layout="row">
                        <md-input-container class="md-block" flex="20">
                            <label>Pais</label>
                            <md-select ng-disabled="$parent.enabled" ng-model="bnk.pais" name="state"
                                       ng-disabled="$parent.enabled" ng-change="setState(this)" md-no-ink>
                        ...
                        <md-input-container class="md-block" flex="20">
                            <label>Estado</label>
                            <md-select ng-disabled="$parent.enabled" ng-model="bnk.est" name="state"
                                       ng-disabled="$parent.enabled || (bnk.pais==false)" md-no-ink>
                        ...
                        <md-input-container class="md-block" flex="20">
                            <label>Ciudad</label>
                            <md-select ng-disabled="$parent.enabled" ng-model="bnk.ciudad" name="state"
                                       ng-disabled="$parent.enabled || (bnk.est==false)" required md-no-ink>
                ...
                <form name="provMoneda" ng-controller="coinController">
                    ...
                    <div layout="row">
                        <md-input-container class="md-block" flex="20">
                            ...
                            <md-select ng-model="cn.coin" name="state"
                                       ng-disabled="(coins.length == filt.length) || $parent.enabled" required
                                       md-no-ink>
                ...
                <form name="provCred" ng-controller="creditCtrl" ng-click="showGrid(true)" click-out="showGrid(false)">
                    <div class="titulo_formulario" layout="row" layout-align="start start" flex
                         ng-class="{'onlyread' : (!$parent.edit || coins.length<1)}">
                        <div style="height: 30px;" layout="row">
                            Credito
                            <div class="circle" ng-bind="limits.length"></div>
                        </div>
                    </div>
                    <div layout="row">
                        <md-input-container class="md-block" flex="30">
                        ...
                        <md-input-container class="md-block" flex="20">
                            <label>Moneda</label>
                            <md-select ng-model="cred.coin" name="state" ng-disabled="$parent.enabled || coins.length<1"
                                       ng-controller="provCoins" required md-no-ink>
                ...
                <!-- ########################################## FORMULARIO CREDITOS ########################################## -->
                <form name="condHeadFrm" ng-controller="condPayList" ng-click="showGrid(true)"
                      click-out="showGrid(false)">
                    <div class="titulo_formulario" layout="row" layout-align="start start" flex
                         ng-class="{'onlyread' : (!$parent.edit)}">
                        <div style="height: 30px" layout="row">
                        ...
                        <div id="grid">
                            <div flex ng-repeat="condition in conditions" ng-click="toEdit(this)">
                                <div layout="row" layout-wrap class="cellGridHolder" style="height: 50px">
                                    ...
                                    <div flex class="cellGrid"><span ng-repeat="item in condition.items">{{item.porcentaje}}% {{item.dias}} dias, {{item.descripcion}} | </span>
                                    </div>
                                    <!--                                    </div>-->
                                    <!--                                    <div flex layout="row">-->
                ...
                <form name="provConv" ng-controller="convController" ng-click="showGrid(true)"
                      click-out="showGrid(false)">
                    <div class="titulo_formulario" layout="row" layout-align="start start" flex
                         ng-class="{'onlyread' : (!$parent.edit || coins.length < 1)}">
                        <div style="height: 30px;" layout="row">
                    ...
                    <div layout="row">
                        ...
                        <md-input-container class="md-block" flex="20" ng-controller="provCoins">
                            <label>Moneda</label>
                            <md-select ng-disabled="$parent.enabled || coins.length < 1" ng-model="conv.coin"
                                       name="state" required md-no-ink>
                                <md-option ng-repeat="coin in coins" value="{{coin.id}}">
                                    {{coin.nombre}}
                                </md-option>
                            </md-select>
                ...
                <!-- ########################################## FORMULARIO PUNTOS ########################################## -->
                <form name="provPoint" ng-controller="provPointController" ng-click="showGrid(true)"
                      click-out="showGrid(false)">
                    <div class="titulo_formulario" layout="column" layout-align="start start" flex
                         ng-class="{'onlyread' : (!$parent.edit || coins.length < 1)}">
                        <div>
                    ...
                    <div layout="row">
                        ...
                        <md-input-container class="md-block" flex="20" ng-controller="provCoins">
                            <label>Moneda</label>
                            <md-select ng-disabled="$parent.enabled || coins.length < 1" ng-model="pnt.coin" required
                                       md-no-ink>
        ...
        <md-sidenav style="margin-top:96px; margin-bottom:48px; width: 360px;"
                    class="md-sidenav-right md-whiteframe-2dp" md-disable-backdrop="true" md-component-id="payCond">
            <md-content class="cntLayerHolder" layout="column" layout-padding flex
                        ng-controller="payCondItemController">
                ...
                <form name="itemCondForm">
                    <div layout="row">
                        ...
                        <md-input-container class="md-block" flex>
                            ...
                            <md-select ng-disabled="$parent.enabled" ng-model="condItem.condit"
                                       ng-disabled="$parent.enabled" required md-no-ink>
                                <md-option
                                    ng-repeat="cond in [{name:'adelanto',id:0},{name:'contra BL',id:1},{name:'despues de carga',id:2},{name:'antes carga',id:3},]"
                                    value="{{cond.name}}">
                                    {{cond.name}}
                                </md-option>
                            </md-select>
        ...
        <md-sidenav style="margin-top:96px; margin-bottom:48px; width: calc(100% - 336px);" layout="row"
                    class="md-sidenav-right md-whiteframe-2dp" md-disable-backdrop="true" md-component-id="layer3"
                    id="layer3">
            <md-content class="cntLayerHolder" layout="column" layout-padding flex>
                ...
                <form name="timeProd" ng-click="showGrid(true)" click-out="showGrid(false)">
                    ...
                    <div layout="row">
                        ...
                        <md-input-container class="md-block" flex="20">
                            <label>Linea</label>
                            <md-select ng-disabled="$parent.enabled" ng-model="tp.line" name="state"
                                       ng-disabled="$parent.enabled" md-no-ink>
                                <md-option ng-repeat="line in lines" value="{{line.id}}">
                                    {{line.linea}}
                                </md-option>
                            </md-select>
                ...
                <form name="timeTrans" ng-controller="transTimeController" ng-click="showGrid(true)"
                      click-out="showGrid(false)">
                    <div class="titulo_formulario" layout="column" layout-align="start start" flex
                         ng-class="{'onlyread' : (!$parent.edit)}">
                        <div>
                    ...
                    <div layout="row">
                        ...
                        <md-input-container class="md-block" flex="20">
                            <label>Pais</label>
                            <md-select ng-disabled="$parent.enabled" ng-model="ttr.country" name="state"
                                       ng-disabled="$parent.enabled" md-no-ink required>
                ...
                <form name="provPrecList">
                    ...
                    <div layout="column" ng-show="isShow">
                        ...
                        <div id="grid" style="overflow-y: auto; height: 120px">
                            <div flex
                                 ng-repeat="add in [{ref:'dasdnl',file:'img.jpg'},{ref:'dasdnl',file:'img.jpg'},{ref:'dasdnl',file:'img.jpg'}]"
                                 ng-click="toEdit(this)">
                                <div layout="row" layout-wrap class="cellGridHolder">
        ...
        <!-- 8) ########################################## BOTON Next ########################################## -->
        <div ng-controller="notificaciones" ng-include="template">
        </div>
    </div>
