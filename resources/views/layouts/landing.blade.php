    ...
    <div class="container">
        <div class="row centered">
            ...
            <div class="col-lg-2">
                ...
                <img class="hidden-xs hidden-sm hidden-md" src="{{ url('/img/arrow1.png') }}">
            </div>
            <div class="col-lg-8">
                <img class="img-responsive" src="{{ url('/img/app-bg.png') }}" alt="">
            </div>
            <div class="col-lg-2">
                <br>
                <img class="hidden-xs hidden-sm hidden-md" src="{{ url('/img/arrow2.png') }}">
...
<div id="intro">
    <div class="container">
        <div class="row centered">
            ...
            <br>
            <div class="col-lg-4">
                <img src="{{ url('/img/intro01.png') }}" alt="">
                <h3>Community</h3>
            ...
            <div class="col-lg-4">
                <img src="{{ url('/img/intro02.png') }}" alt="">
                <h3>Schedule</h3>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
            </div>
            <div class="col-lg-4">
                <img src="{{ url('/img/intro03.png') }}" alt="">
                <h3>Monitoring</h3>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 centered">
                <img class="centered" src="{{ url('/img/mobile.png') }}" alt="">
            </div>
                ...
                <div id="carousel-example-generic" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="{{ url('/img/item-01.png') }}" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ url('/img/item-02.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
